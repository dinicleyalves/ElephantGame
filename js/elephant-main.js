...
*/
   ...
   // GAME LOGIC - Modo de depuração do jogo - Lógico (true or false)
   var debugmode = false;
   ...
   // Definição da var de replay do GAME
   var replayclickable = false;

   // Definição dos sons do GAME
   var volume = 30;
   ...
   // Definição dos loops do GAME e dos canos
   var loopGameloop;
   var loopPipeloop;
...
/* 
   /// FUNÇÕES DO JOGO - FUNCTIONS GAME ////
*/
   ...
   // Função mostrar a Tela BoraJogar screen
   function showBoraJogar()
   {
      // variavel para armazenar o estado do jogo e tratar posteriormente os eventos
      currentstate = states.BoraJogarScreen;
      ...
      // fade para a BoraJogar screen aparecer
      $("#borajogar").transition({ opacity: 1 }, 2000, 'ease');
   }
   ...
   function startGame()
   {
      ...
      // fade para a BoraJogar screen sumir
      $("#borajogar").stop();
      $("#borajogar").transition({ opacity: 0 }, 500, 'ease');
   ...
   function gameloop() {
      ...
      var phptopo = $("#phptopo");
      if(boxtop <= (phptopo.offset().top + phptopo.height()))
         position = 0;
   ...
   function screenClick()
   {
      ...
      else if(currentstate == states.BoraJogarScreen)
      {
         startGame();
      }
   }
   ...
   function playerDead()
   {
      ...
      var floor = $("#area-elephantgame").height();
   ...
   function showScore()
   {
      ...
      $("#scorepoints").css({ y: '40px', opacity: 0 }); // Move o quadro de score para biaxo
      $("#replay").css({ y: '40px', opacity: 0 });
      $("#scorepoints").transition({ y: '0px', opacity: 1}, 600, 'ease', function() {
   ...
   $("#replay").click(function() {
      // APERTANDO BARRA ESPAÇO, ou CLICK MOUSE
      if(!replayclickable)
         return;
      else
      ...
      $("#scorepoints").transition({ y: '-40px', opacity: 0}, 1000, 'ease', function() {
         // Esconde o quadro de score
         $("#scorepoints").css("display", "none");
         
         // começa o game over e mostra a BoraJogar screen
         showBoraJogar();
      });
   });
   ...
   function updatePipes()
   {
      ...
      $("#area-elephantgame").append(newpipe);
      pipes.push(newpipe);
   }
